...
declare class ReactRefreshPlugin {
   ...
   */
  constructor(options?: import('@pmmmwh/react-refresh-webpack-plugin/types/lib/types').ReactRefreshPluginOptions);
  /**
   * @readonly
   * @type {import('./types').NormalizedPluginOptions}
   */
  readonly options: import('@pmmmwh/react-refresh-webpack-plugin/types/lib/types').NormalizedPluginOptions;
  /**
   * Applies the plugin.
